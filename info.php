...
<div class="panel-body">
        ...
        <input type="hidden" name="mode" value="" />
          ...
          <tr>
            ...
            <ul class="nav nav-tabs">
              ...
              <li><a href="#tab-downloads">Downloads</a></li>
              <li><a href="#tab-extra">Extra</a></li>
          </ul>
      ...
      $registry->set('load', $loader);
                                     ...
                                     $action = new Action('tool/ka_import/showSelector',array("delimiter", $delimiters, $params['delimiter'], 'style="width:300px;"'));
                                         $sumit = $action->execute($registry);
                                         //$sumit->save();
            ...
            <tr>
              ...
              <td>
                <?php 
                  ...
                  echo showSelector("fields[$fv[field]]", $columns, $val); 
                ?>
              </td>
        ...
        <table class="list">
          ...
          <?php foreach($matches['attributes'] as $ak => $av) { ?>
            <tr>
              ...
              <td>
                <?php echo showSelector("attributes[$av[attribute_id]]", $columns, $av['column']); ?>
              </td>
          ...
          <table class="list">
            ...
            <?php foreach($matches['filter_groups'] as $fk => $fv) { ?>
              <tr>
                ...
                <td>
                  <?php echo showSelector("filter_groups[$fv[filter_group_id]]", $columns, $fv['column']); ?>
                </td>
                <td width="50%">&nbsp;</td>
              </tr>
            <?php } ?>
        ...
        <table class="list">
          ...
          <?php foreach($matches['options'] as $ok => $ov) { ?>
            <tr>
              ...
              <td>
                <?php echo showSelector("options[$ov[option_id]]", $columns, $ov['column']); ?>
              </td>
        ...
        <table class="list">
          ...
          <?php foreach($matches['ext_options'] as $dk => $dv) { ?>
            <tr>
              ...
              <td>
                <?php echo showSelector("ext_options[$dv[field]]", $columns, $dv['column']); ?>
              </td>
        ...
        <table class="list">
          ...
          <?php foreach($matches['discounts'] as $dk => $dv) { ?>
            <tr>
              <td width="25%"><?php echo $dv['name'] ?></td>
              <td>
                <?php echo showSelector("discounts[$dv[field]]", $columns, $dv['column']); ?>
              </td>
              <td width="50%"><span class="help"><?php echo $dv['descr']; ?></span></td>
            </tr>
          <?php } ?>
        ...
        <table class="list">
          ...
          <?php foreach($matches['specials'] as $dk => $dv) { ?>
            <tr>
              <td width="25%"><?php echo $dv['name'] ?></td>
              <td>
                <?php echo showSelector("specials[$dv[field]]", $columns, $dv['column']); ?>
              </td>
              <td width="50%"><span class="help"><?php echo $dv['descr']; ?></span></td>
            </tr>
          <?php } ?>
        ...
        <table class="list">
          ...
          <?php foreach($matches['reward_points'] as $dk => $dv) { ?>            
            <tr>
              <td width="25%"><?php echo $dv['name'] ?></td>
              <td>
                <?php echo showSelector("reward_points[$dv[field]]", $columns, $dv['column']); ?>
              </td>
              <td width="50%"><span class="help"><?php echo $dv['descr']; ?></span></td>
            </tr>
          <?php } ?>
          ...
          <table class="list">
            ...
            <?php foreach($matches['product_profiles'] as $dk => $dv) { ?>            
              <tr>
                <td width="25%"><?php echo $dv['name'] ?></td>
                <td>
                  <?php echo showSelector("product_profiles[$dv[field]]", $columns, $dv['column']); ?>
                </td>
                <td width="50%"><span class="help"><?php echo $dv['descr']; ?></span></td>
              </tr>
            <?php } ?>
