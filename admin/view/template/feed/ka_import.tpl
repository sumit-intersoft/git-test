                        ...
                        <div class="tab-pane active" id="tab-general">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="left">Set tax class for new products
                                            <span class="help">This option is ignored if the tax field is defined in the file</span>
                                        </td>
                                        <td class="left">
                                            <select name="ka_import_pi_tax_class_id_for_new_products" id="input-tax-class" class="form-control">
                                                <option value="0"><?php echo $text_none; ?></option>
                                                <?php foreach ($tax_classes as $tax_class) { ?>
                                                <?php if ($tax_class['tax_class_id'] == $ka_import_pi_tax_class_id_for_new_products) { ?>
                                    ...
                                    <tr>
                                        <td class="left">Set stock status for new products
                                            <span class="help">This option is ignored if the stock status field is defined in the file</span>
                                        </td>
                                        <td class="left">
                                            <select name="ka_import_pi_stock_status_id_for_new_products" id="input-stock-status" class="form-control">
                                                <?php foreach ($stock_statuses as $stock_status) { ?>
                                                <?php if ($stock_status['stock_status_id'] == $ka_import_pi_stock_status_id_for_new_products) { ?>
